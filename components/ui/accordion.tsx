...
import { DownIcon } from "@/app/shared/icons";
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <DownIcon className="text-muted-foreground pointer-events-none size-5.5 shrink-0 translate-y-0.5 transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
